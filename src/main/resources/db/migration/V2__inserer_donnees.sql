...
INSERT INTO patients (id, nom, prenom, telephone, adresse, date_naissance, user_id, medecin_id) VALUES
(1, 'Dupont', 'Jean', '0600112233', '12 Rue de Paris, Casablanca', '1985-05-12', 4, 1),
(2, 'Martin', 'Sophie', '0655443322', '45 Avenue Mohammed V, Rabat', '1992-09-28', 5, 2);

INSERT INTO rendezvous (id, date_rendez_vous, statut, patient_id, medecin_id) VALUES
(1, '2026-10-10 10:00:00', 'CONFIRME', 1, 1),
(2, '2026-10-11 14:30:00', 'EN_ATTENTE', 2, 2),
(3, '2026-10-12 09:15:00', 'ANNULE', 1, 1);
